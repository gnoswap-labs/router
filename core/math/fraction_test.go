...
func TestNewFraction(t *testing.T) {
	...
	for _, test := range tests {
		t.Run("", func(t *testing.T) {
			...
			//fmt.Println(fraction.Numerator.String(), fraction.Denominator.String(), expectedFraction.Numerator.String(), expectedFraction.Denominator.String())

			if expectedFraction.Numerator.Cmp(fraction.Numerator) != 0 || expectedFraction.Denominator.Cmp(fraction.Denominator) != 0 {
				t.Fatalf("NewFraction: expected %v/%v, got %v/%v", expectedFraction.Numerator, expectedFraction.Denominator, fraction.Numerator, fraction.Denominator)
			}
		})
	}
}
...
//		tt := tt
//		t.Run("", func(t *testing.T) {
//			fraction1, _ := NewFraction(tt.numerator1, tt.denominator1)
//			fraction2, _ := NewFraction(tt.numerator2, tt.denominator2)
//			result, _ := fraction1.Sub(fraction2)
//			expected, _ := NewFraction(tt.expectedNumerator, tt.expectedDenominator)
//
...
//			fraction1, _ := NewFraction(tt.numerator1, tt.denominator1)
//			fraction2, _ := NewFraction(tt.numerator2, tt.denominator2)
//			result, _ := fraction1.Add(fraction2)
//			expected, _ := NewFraction(tt.expectedNumerator, tt.expectedDenominator)
//
//			fraction2.Add(NewFraction(1, 2))
//
//			if result.Numerator.Cmp(expected.Numerator) != 0 || result.Denominator.Cmp(expected.Denominator) != 0 {
//				t.Fatalf("Add: expected %v, got %v", expected, result)
//			}
