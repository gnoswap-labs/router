...
// rounding 변수는 일단 사용X
func (f *Fraction) ToSignificant(significantDigits int, rounding core.Rounding) string {
	//invariant(
	...
	// TODO: 여기서 오차 안생기나 확인
	quotient := big.NewRat(f.Numerator.Int64(), f.Denominator.Int64())
	return quotient.FloatString(significantDigits)
}

func (f *Fraction) ToFixed(significantDigits int, rounding core.Rounding) string {
	//invariant(
